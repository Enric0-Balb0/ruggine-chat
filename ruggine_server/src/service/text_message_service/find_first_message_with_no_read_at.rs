...
impl TextMessageService {
    pub async fn find_first_message_with_no_read_at_inner(&self, auth_user_id: i32, group_chat_id: i32) -> Result<Option<TextMessageReadDto>, ApiError> {
        ...
        let text_message = self.text_message_repo
            .find_first_message_with_no_read_at(auth_user_id, group_chat_id)
            .await
