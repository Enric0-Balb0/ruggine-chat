...
mod tests {
    ...
    #[tokio::test]
    async fn test_find_by_group_id_checked_internal_success() {
    ...
    #[tokio::test]
    async fn test_find_by_group_id_checked_internal_group_not_found() {
    ...
    #[tokio::test]
    async fn test_find_by_group_id_checked_internal_user_not_in_group() {
        let mut mock_repo = MockGroupMembershipRepositoryTrait::new();
        let mut mock_group_service = MockGroupChatServiceTrait::new();
        let mock_user_service = MockUserServiceTrait::new();
    ...
    #[tokio::test]
    async fn test_find_by_group_id_checked_internal_user_left_group() {
        let mut mock_repo = MockGroupMembershipRepositoryTrait::new();
        let mut mock_group_service = MockGroupChatServiceTrait::new();
        let mock_user_service = MockUserServiceTrait::new();
    ...
    #[tokio::test]
    async fn test_find_by_group_id_checked_internal_empty_result() {
        let mut mock_repo = MockGroupMembershipRepositoryTrait::new();
        let mut mock_group_service = MockGroupChatServiceTrait::new();
        let mock_user_service = MockUserServiceTrait::new();
    ...
    #[tokio::test]
    async fn test_find_by_group_id_checked_internal_database_error() {
        let mut mock_repo = MockGroupMembershipRepositoryTrait::new();
        let mut mock_group_service = MockGroupChatServiceTrait::new();
        let mock_user_service = MockUserServiceTrait::new();
